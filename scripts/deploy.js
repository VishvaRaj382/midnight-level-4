...
const witnesses = {
  localSecretKey: (context) => [context.privateState, context.privateState.localSecretKey],
  rawIdentitySecret: (context) => [context.privateState, context.privateState.rawIdentitySecret],
  rawApiTokenSecret: (context) => [context.privateState, context.privateState.rawApiTokenSecret],
};
