...
async function deploy(): Promise<string> {
  ...
  const cleanAddress = deployedAddress.replace(/^0x/, '');
  ...
  console.log(`📍 Midnight Explorer URL   : https://explorer.preprod.midnight.network/contract/${cleanAddress}`);
  console.log(`📍 Live DApp URL           : https://vishvaraj382.github.io/midnight-level-4/`);
  console.log('====================================================');
